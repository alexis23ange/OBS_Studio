...
#include "../../../obs-studio-0.6.4/obs/window-basic-interaction.hpp"
...
QT_MOC_LITERAL(2, 41, 0)
    ...
    "OBSBasicInteraction\0OnInteractionResized\0"
    ""
};
...
void OBSBasicInteraction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OBSBasicInteraction *_t = static_cast<OBSBasicInteraction *>(_o);
        switch (_id) {
        case 0: _t->OnInteractionResized(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
