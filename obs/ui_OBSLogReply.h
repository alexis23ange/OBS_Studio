...
public:
    ...
    {
        OBSLogReply->setWindowTitle(QApplication::translate("OBSLogReply", "LogReturnDialog", 0));
        copyURL->setText(QApplication::translate("OBSLogReply", "LogReturnDialog.CopyURL", 0));
    } // retranslateUi
